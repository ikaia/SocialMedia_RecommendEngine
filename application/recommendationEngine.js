...
capStoneEngine.addRating("FakeUser_Horror", 11, 5.0); 
capStoneEngine.addRating("FakeUser_Action", 10, 5.0);  
capStoneEngine.addRating("FakeUser_Comedy", 9, 5.0);
capStoneEngine.addRating("TestUser", 5, 5);
